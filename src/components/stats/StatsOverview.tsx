...
export const StatsOverview = () => {
  ...
  return (
    <div className="flex-1 p-4 flex flex-col h-[calc(100vh-4rem)] overflow-hidden">
      <StatsHeader />
      
      <Tabs defaultValue="overview" className="flex-1 flex flex-col mt-2 overflow-hidden">
        ...
        <TabsContent value="overview" className="flex-1 space-y-3 overflow-hidden">
          <div className="grid gap-3 md:grid-cols-2 lg:grid-cols-4">
            <Card className="shadow-sm">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-1 pt-2 text-left">
          ...
          <div className="grid gap-3 md:grid-cols-2 lg:grid-cols-7 flex-1 overflow-hidden">
            <Card className="col-span-4 shadow-sm overflow-hidden">
              <CardHeader className="py-2 text-left">
                <CardTitle>Sales Overview</CardTitle>
                <CardDescription>
                  Your sales performance for the last 6 months
                </CardDescription>
              </CardHeader>
              <CardContent className="p-0 h-[calc(100%-4.5rem)] overflow-hidden">
                <SalesChart />
              </CardContent>
            </Card>
            <Card className="col-span-3 shadow-sm overflow-hidden">
              ...
              <CardContent className="h-[calc(100%-4.5rem)] overflow-hidden">
                <TopProducts />
              </CardContent>
            </Card>
          </div>
        ...
        <TabsContent value="selling" className="flex-1 space-y-3 overflow-hidden">
          <div className="grid gap-3 md:grid-cols-2 lg:grid-cols-3 h-full overflow-hidden">
        ...
        <TabsContent value="buying" className="flex-1 space-y-3 overflow-hidden">
